...
cd 95
if [ ! -f "win95.7z" ]; then
wget http://d.ixcmstudio.cn:21188/doc/飞屎OS/VM/win95.7z
fi
7z x -aos win95.7z
echo "虚拟机启动，镜像来自镜连"
qemu-system-i386 -m 256 -hda win95.img -soundhw sb16 -vnc :0
	...
	cd xp
	if [ ! -f "xp.zip" ];then
		wget http://d.ixcmstudio.cn:21188/doc/飞屎OS/VM/xp.7z
		wget http://d.ixcmstudio.cn:21188/doc/飞屎OS/VM/xp.zip
	fi
